...
class Node 
{
	...
	// the following is used to comapre nodes in the FOCAL list (ignore)
	...
	typedef pairing_heap< Node* , boost::heap::compare<Node::compare_node> >
	::handle_type open_handle_t;
	typedef pairing_heap< Node* , boost::heap::compare<Node::secondary_compare_node> >
	...
	// /* TODO:  */his is needed because otherwise we'll have to define the specialized template inside std namespace
	struct NodeHasher 
	{
